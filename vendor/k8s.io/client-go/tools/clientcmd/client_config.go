...
// BuildConfigFromFlags is a client function that builds configs from a master
...
// BuildConfigFromKubeconfigGetter is a client function that builds configs from a master
